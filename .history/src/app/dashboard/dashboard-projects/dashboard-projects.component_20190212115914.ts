...
const ELEMENT_DATA: PeriodicElement[] = [
  { position: 1001, name: 'Test User', weight: 'Tania Koch', symbol: 'H' },
  { position: 1002, name: 'Preston Case', weight: 'Tania Koch', symbol: 'H' },
  { position: 1003, name: 'Preston Case', weight: 'Tania Koch', symbol: 'H' },
  { position: 1004, name: 'Preston Case', weight: 'Tania Koch', symbol: 'H' },
  { position: 1005, name: 'Preston Case', weight: 'Tania Koch', symbol: 'H' }
