...
const ELEMENT_DATA: PeriodicElement[] = [
  ...
  { position: 1002, name: 'Test User', weight: 'Tania Koch', symbol: 'H' },
  { position: 1003, name: 'Test User', weight: 'Tania Koch', symbol: 'H' },
  { position: 1004, name: 'Test User', weight: 'Tania Koch', symbol: 'H' },
  { position: 1005, name: 'Test User', weight: 'Tania Koch', symbol: 'H' }
